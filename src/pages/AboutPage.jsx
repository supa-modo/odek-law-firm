...
const AboutPage = () => {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-slate-100 to-slate-200 relative">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-5 pointer-events-none">
          <div
            className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        ...
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-14 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-slate-700 max-w-4xl mx-auto">
            ...
            {teamHighlights.map((highlight, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: false, amount: 0.3 }}
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                  className="bg-white p-8 rounded-lg shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300"
                >
