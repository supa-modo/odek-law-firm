...
const AboutSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[95%] mx-auto px-2 sm:px-6 lg:px-14">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-4">
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 space-y-10 lg:space-y-16 space-x-5 lg:space-x-10">
